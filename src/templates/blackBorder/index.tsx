...
export default function BlackBorder({ resume }: { resume: Resume }) {
  ...
  return <div className={styles.root}>
    ...
    <div className={styles.header}>
      ...
      <img src={leafImage} className={styles.headerImg} />
    </div>
    <div className={styles.main}>
      ...
      <div className={styles.mainPart}>
        {
          introduction && <div className={styles.block}>
