...
import introductionIcon from './introduction.png';
...
export default function GreenGray({ resume }: { resume: Resume }) {
  ...
  return <div className={styles.root}>
    <div className={styles.sider}>
      ...
      <div className={styles.siderContent}>
        <div>
          <h2 className={styles.infosTitle}>个人信息</h2>
    ...
    <div className={styles.mainPart}>
      {
        introduction && <div className={styles.introduction}>
          <h2><Icon url={introductionIcon} />个人简介</h2>
      ...
      }
      {
        educations.length > 0 &&
        <div>
          <h2><Icon url={educationIcon} />教育经历</h2>
          <div className={styles.mainBlock}>
      ...
      }
      {
        projects.length > 0 &&
        <div>
          <h2><Icon url={projectIcon} />项目经历</h2>
          <div className={styles.mainBlock}>
